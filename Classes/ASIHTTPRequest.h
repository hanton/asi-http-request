...
typedef enum {
    ERequestType_Init = 0,
    ERequestType_QueryAccountInfo,//1
    ERequestType_CreateSubAccount,//2
    ERequestType_GetSubAccounts,//3
    ERequestType_QuerySubAccount,//4
    ERequestType_SendSMS,//5
    ERequestType_SendTemplateSMS,//6
    ERequestType_CallBack,//7
    ERequestType_LandingCall,//8
    ERequestType_VoiceVerify,//9
    ERequestType_IvrDial,//10
    ERequestType_BillRecords,//11
} ERequestType;
